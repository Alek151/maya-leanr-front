...
const AbecedarioScreen = () => {
  ...
  const abecedarioData = [
    { letter: '0', image: require('../img/letra_a.jpg'), audio: require('../assets/sound/grabacion.mp3') },
    { letter: '1', image: require('../img/letra_e.png'), audio: require('../assets/sound/audio.mp3') },
    { letter: '2', image: require('../img/letra_i.jpg'), audio: require('../assets/sound/grabacion.mp3') },
    { letter: '3', image: require('../img/letra_o.jpg'), audio: require('../assets/sound/audio.mp3') },
    { letter: '4', image: require('../img/letra_u.jpg'), audio: require('../assets/sound/audio.mp3') },
    { letter: '5', image: require('../img/letra_a.jpg'), audio: require('../assets/sound/grabacion.mp3') },
    { letter: '6', image: require('../img/letra_e.png'), audio: require('../assets/sound/audio.mp3') },
    { letter: '7', image: require('../img/letra_i.jpg'), audio: require('../assets/sound/grabacion.mp3') },
    { letter: '8', image: require('../img/letra_o.jpg'), audio: require('../assets/sound/audio.mp3') },
    { letter: '9', image: require('../img/letra_u.jpg'), audio: require('../assets/sound/audio.mp3') }
  ];
